#
# Takes drive letter as parameter ("powershell.exe Move_IIS.ps1 D") and then move whole Inetpub folder to other drive. Found on some site in internet, (c) not me.
#
